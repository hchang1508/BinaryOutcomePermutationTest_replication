...
#output file name
save_path_500=  paste0("/home/hc654/palmer_scratch/binary_outcome_sim/unbalanced_s2/n500/",'balanced_design_',index,'_500_',nperm,'.csv')
...
#The number of treated units is nt=0.4*n.
