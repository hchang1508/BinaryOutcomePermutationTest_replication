...
output_50_s1=c()
for (i in 1:length(files_s1_50)){
  output_50_s1=c(output_50_s1, read.csv(files_s1_50[i])[,10])
}
result_50_s1=c(mean(output_50_s1),median(output_50_s1))
result_50_s1
########
#n=100##
########
...
output_100_s1=c()
for (i in 1:length(files_s1_100)){
  output_100_s1=c(output_100_s1, read.csv(files_s1_100[i])[,10])
}
result_100_s1=c(mean(output_100_s1),median(output_100_s1))
result_100_s1
...
output_200_s1=c()
for (i in 1:length(files_s1_200)){
  output_200_s1=c(output_200_s1, read.csv(files_s1_200[i])[,10])
}
result_200_s1=c(mean(output_200_s1),median(output_200_s1))
result_200_s1
...
output_50_s2=c()
for (i in 1:length(files_s2_50)){
  output_50_s2=c(output_50_s2, read.csv(files_s2_50[i])[,10])
}
result_50_s2=c(mean(output_50_s2),median(output_50_s2))
result_50_s2
...
output_100_s2=c()
for (i in 1:length(files_s2_100)){
  output_100_s2=c(output_100_s2, read.csv(files_s2_100[i])[,10])
}
result_100_s2=c(mean(output_100_s2),median(output_100_s2))
result_100_s2
...
output_200_s2=c()
for (i in 1:length(files_s2_200)){
  output_200_s2=rbind(output_200_s2, read.csv(files_s2_200[i])[,10])
}

result_200_s2=c(mean(output_200_s2),median(output_200_s2))
result_200_s2
