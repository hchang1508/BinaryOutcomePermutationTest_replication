...
compare_ATE_inner_unbalanced = function(i,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=TRUE,warning_msg=FALSE){
  ...
  result_test_case = permutation_test(data, test_type , alpha=0.05, epsilon=0, nperm=nperm,return_interval = TRUE ,display_progress = display_progress,warning_msg=warning_msg  )
  end_time=proc.time()
  dim_time=(end_time-start_time)[3]
...
compare_ATE_unbalanced = function(nsim,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=TRUE,warning_msg=FALSE){
  
  
  result_mat = pbsapply(1:nsim, function(i) compare_ATE_inner_unbalanced(i,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=display_progress,warning_msg=warning_msg))
...
compare_ATE_inner_balanced_design_unbalanced_algorithm = function(i,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=TRUE,warning_msg=FALSE){
  ...
  #permutation test
  start_time=proc.time() #time the code
  result_test_case = permutation_test_balanced_design_unbalanced_algorithm(data, test_type , alpha=0.05, epsilon=0, nperm=nperm,return_interval = TRUE ,display_progress = display_progress,warning_msg=warning_msg  )
  end_time=proc.time()
  dim_time=(end_time-start_time)[3]
  ...
  output = c(cov_perm=cov_perm,perm_width=perm_width, dim_time=dim_time) #output as a vector
  return(output)
  
}

compare_ATE_balanced_design_unbalanced_algorithm = function(nsim,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=TRUE,warning_msg=FALSE){


  result_mat = pbsapply(1:nsim, function(i) compare_ATE_inner_balanced_design_unbalanced_algorithm(i,n,nt,v11_share,v10_share,v01_share,test_type,nperm,display_progress=display_progress,warning_msg=warning_msg))

  result_mat = t(result_mat)
  
  colnames(result_mat) = c('cov_perm','perm_width','dim_time')
  return(result_mat)
}
