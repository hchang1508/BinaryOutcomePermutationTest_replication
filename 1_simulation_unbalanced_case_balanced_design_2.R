...
#output file name
save_path_50= paste0("/home/hc654/palmer_scratch/binary_outcome_sim/unbalanced_s2/n50/",'balanced_design_',index,'_50_' ,nperm, '.csv')
save_path_100= paste0("/home/hc654/palmer_scratch/binary_outcome_sim/unbalanced_s2/n100/",'balanced_design_',index,'_100_' ,nperm, '.csv')
save_path_200=  paste0("/home/hc654/palmer_scratch/binary_outcome_sim/unbalanced_s2/n200/",'balanced_design_',index,'_200_' ,nperm, '.csv')
