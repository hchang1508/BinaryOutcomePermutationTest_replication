...
# nperm: the number of permutation draws. If nperm=0, the function will calculate the number of permutation draws based on epsilon.
    ...
    if (nperm==0){
        ...
        nperm = round(1/(epsilon^2)* log(4*n*log(n,2)/epsilon)/2)+1 #number of simulated draws
        print(nperm)
...
permutation_test_balanced_design_unbalanced_algorithm = function(data, test_type, alpha=0.05, epsilon=0.01,nperm=0,return_interval=TRUE,display_progress=TRUE,warning_msg=FALSE){
...
# nperm: the number of permutation draws. If nperm=0, the function will calculate the number of permutation draws based on epsilon.
    ...
    if (test_type==1){
        ...
        result_table=perm_test_interface_balanced_design_unbalanced_algorithm(test_statistic, test_type , alpha, epsilon,n11,n10,n01,n00,n,nt,nperm,Cn_preprocessed,length(Cn_preprocessed),display_progress=display_progress,return_interval=return_interval,warning_msg=warning_msg)
